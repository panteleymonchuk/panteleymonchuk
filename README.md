# 👋 Yevhenii Panteleimonchuk (@panteleymonchuk)
...
- **Supply Chain Platform** — blockchain-based platform for ports and logistics operators, built on ODRL / W3C DID/VC
- **IOTA SDK 2.0** — update by upstream changes, cross-team sync, shipped in under 3 months, 95% OKR completion
- **Hardware Wallet Integrations** — Ledger, Keystone, signing flows end-to-end

### Track Record
- Delivered 15+ client projects leading 3 cross-functional teams
- Products I've worked on raised $5M+ and £3.7M post-MVP
